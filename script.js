...
const openedCookie = document.querySelector('.open-another-cookie');
...
cookie.addEventListener('click', handleClick /*função*/ );
openedCookie.addEventListener('click', handleResetClick /*função*/ );

function handleClick() {
  activeToggle();

  textSecondScreen.innerText = frases[randomNumber];
}
